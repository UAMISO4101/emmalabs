...
!function($) {
    ...
    FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var pcolors = ['#7578f9', '#5cb45b'];
          var borderColor = '#efefef';
          var bgColor = '#fff';
          this.createPlotGraph("#website-stats", uploads, downloads, plabels, pcolors, borderColor, bgColor);

          //Pie graph data
          var pielabels = ["Service 1","Service 2","Service 3"];
          var datas = [20,30, 15];
          var colors = ["#dcdcdc", '#7578f9', '#5cb45b'];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#1d1e3a']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutlabels = ["Service 1","Service 2","Service 3","Service 4","Service 5"];
          var donutdatas = [35,20, 10];
          var donutcolors = ['#5cb45b', '#ed699b', "#dcdcdc"];
